  ...
  return (
    <section className="relative bg-gradient-to-br from-ramen-cream to-white py-20 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl md:text-6xl font-noto-kr font-semibold text-ramen-dark mb-6 animate-fade-in">
          Bold Korean Flavors, Slurpy Ramen Bowls
          <span className="block text-ramen-red mt-2">The Studio PH</span>
        </h1>
